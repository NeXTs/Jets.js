$(function() {
  ...
  function fillTweets(amount) {
    ...
    tweets = shuffle([
      ...
      {lang: 'en', used: false, markup: '<blockquote class="twitter-tweet" data-cards="hidden" data-lang="en"><p lang="en" dir="ltr">Jets.js: A Native CSS-Powered Search Feature - <a href="https://t.co/d13xkSpcHP">https://t.co/d13xkSpcHP</a> (Leans on the idea of using CSS selectors to show/hide certain items…</p>&mdash; JavaScript Daily (@JavaScriptDaily) <a href="https://twitter.com/JavaScriptDaily/status/758249596892086272">July 27, 2016</a></blockquote>'},
      {lang: 'en', used: false, markup: '<blockquote class="twitter-tweet" data-cards="hidden" data-lang="en"><p lang="en" dir="ltr">A &quot;search engine&quot; powered by a single concept:<br><br>:not([data-jets *= &quot;search_query&quot;]){ display:none; }<a href="https://t.co/uDteeCYifm">https://t.co/uDteeCYifm</a></p>&mdash; CSS-Tricks (@Real_CSS_Tricks) <a href="https://twitter.com/Real_CSS_Tricks/status/859536330686115840">May 2, 2017</a></blockquote>'}
    ]),
    result = [];
