...
;(function(root, definition) {
    ...
    function Jets(opts) {
        ...
        self.options = {};
        ['disableListeners','columns', 'addImportant', 'searchSelector', 'manualContentHandling', 'diacriticsMap', 'didSearch', 'invert'].forEach(function(name) {
        ...
        if (!self.options.disableListeners){
